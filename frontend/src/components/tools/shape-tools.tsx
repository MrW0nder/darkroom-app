...
export function ShapeTools({ onShapeChange }: ShapeToolsProps) {
  ...
  const updateShapeSetting = (key: string, value: string | number | boolean) => {
  ...
  return (
    <div className="flex flex-col gap-4 p-2">
      ...
      <div className="flex items-center gap-2">
        ...
        {showStrokePicker && (
          <ColorPicker
            selectedColor={shapeSettings.strokeColor}
            onColorChange={(color: string) => updateShapeSetting('strokeColor', color)}
          />
        )}
      ...
      <div className="flex items-center gap-2">
        ...
        {showFillPicker && (
          <ColorPicker
            selectedColor={shapeSettings.fillColor}
            onColorChange={(color: string) => updateShapeSetting('fillColor', color)}
          />
        )}
      ...
      <div>
        ...
        <Slider
          ...
          onValueChange={(value: number[]) => updateShapeSetting('strokeWidth', value[0])}
        />
      </div>
    </div>
  );
