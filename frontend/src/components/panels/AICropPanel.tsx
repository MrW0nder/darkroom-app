...
import { Camera, Grid, Crop, Maximize2 } from 'lucide-react'; // Replaced Grid3x3 with Grid
...
const AICropPanel: React.FC = () => {
  ...
  const cropModes = [
    ...
    { value: 'rule_of_thirds', label: 'Rule of Thirds', icon: Grid }, // Replaced Grid3x3 with Grid
