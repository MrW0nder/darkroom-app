...
export function BrushTool({ onBrushChange }: BrushToolProps) {
  ...
  const updateBrushSetting = (key: string, value: any) => {
    ...
    <div className="flex flex-col gap-4 p-2">
      ...
      <div className="flex items-center gap-2">
        ...
        {showColorPicker && (
          <ColorPicker
            ...
            onChange={(color) => updateBrushSetting('color', color)}
          />
        )}
      ...
      <div>
        ...
        <Slider
          ...
          onValueChange={(value) => updateBrushSetting('size', value[0])}
        />
      </div>
      ...
      <div>
        ...
        <Slider
          ...
          onValueChange={(value) => updateBrushSetting('opacity', value[0])}
        />
      </div>
    </div>
  );
